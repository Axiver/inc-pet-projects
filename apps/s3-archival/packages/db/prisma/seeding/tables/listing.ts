...
const Listings: IListings[] = [
  {
    ...
    createdAt: new Date("2021-04-01T00:00:00.000Z"),
  ...
  },
  {
    ...
    description: "i need nice copper angles, don't give me that 36 angle stuff\n\nI ONLY NEED 89 degress ANGLES",
  ...
  },
  {
    ...
    description: "i actually bought normal bars but they gave me round bars?\n\nNeed to get rid of them urgently, selling at a lower price",
  ...
  },
  {
    ...
    description: "Square bar with excellent mechanical properties, resistance to many corrosive agents needed",
  ...
  },
  {
    ...
    description: "Commercial quality Mild Steel Bar, must be strong and durable for all load bearing applications",
    price: new Prisma.Decimal(100),
    categoryId: 10,
    type: ListingType.BUY,
