...
const main = async (): Promise<void> => {
  ...
  await Promise.allSettled([
    prismaClient.$executeRaw`ALTER SEQUENCE public.access_tokens_id_seq RESTART WITH 1;`,
    prismaClient.$executeRaw`ALTER SEQUENCE public.advertisements_id_seq RESTART WITH 1;`,
    prismaClient.$executeRaw`ALTER SEQUENCE public.category_id_seq RESTART WITH 1;`,
    prismaClient.$executeRaw`ALTER SEQUENCE public.advert_clicks_id_seq RESTART WITH 1;`,
    prismaClient.$executeRaw`ALTER SEQUENCE public.listing_clicks_id_seq RESTART WITH 1;`,
    prismaClient.$executeRaw`ALTER SEQUENCE public.companies_id_seq RESTART WITH 1;`,
    prismaClient.$executeRaw`ALTER SEQUENCE public.companies_bookmarks_id_seq RESTART WITH 1;`,
    prismaClient.$executeRaw`ALTER SEQUENCE public.invite_id_seq RESTART WITH 1;`,
    prismaClient.$executeRaw`ALTER SEQUENCE public.listing_bookmarks_id_seq RESTART WITH 1;`,
    prismaClient.$executeRaw`ALTER SEQUENCE public.listing_images_id_seq RESTART WITH 1;`,
    prismaClient.$executeRaw`ALTER SEQUENCE public.listing_id_seq RESTART WITH 1;`,
    prismaClient.$executeRaw`ALTER SEQUENCE public.messages_id_seq RESTART WITH 1;`,
    prismaClient.$executeRaw`ALTER SEQUENCE public.notification_settings_id_seq RESTART WITH 1;`,
    prismaClient.$executeRaw`ALTER SEQUENCE public.offers_id_seq RESTART WITH 1;`,
    prismaClient.$executeRaw`ALTER SEQUENCE public.parameter_id_seq RESTART WITH 1;`,
    prismaClient.$executeRaw`ALTER SEQUENCE public.refresh_tokens_id_seq RESTART WITH 1;`,
    prismaClient.$executeRaw`ALTER SEQUENCE public.user_bookmarks_id_seq RESTART WITH 1;`,
    prismaClient.$executeRaw`ALTER SEQUENCE public.password_reset_id_seq RESTART WITH 1;`,
  ]);
  ...
  const { count: listingsParametersValueCount } = await prismaClient.listingsParametersValue.createMany({
